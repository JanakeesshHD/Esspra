document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(event) {
            ...
            // Create mailto link
            const subject = `Contact Form: ${formDataObj.subject || 'Inquiry'}`;
            
            let body = `Name: ${formDataObj.name || ''}\n`;
            body += `Email: ${formDataObj.email || ''}\n`;
            body += `Phone: ${formDataObj.phone || ''}\n`;
            body += `Company: ${formDataObj.company || ''}\n`;
            body += `Subject: ${formDataObj.subject || ''}\n`;
            body += `Inquiry Type: ${formDataObj.inquiry || ''}\n`;
            body += `Message: ${formDataObj.message || ''}\n`;
            body += `Newsletter: ${formDataObj.newsletter ? 'Yes' : 'No'}\n`;
            
            const mailtoLink = `mailto:supreethegde@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
    ...
    if (contactForm && !document.querySelector('.success-message')) {
        ...
        successMessage.innerHTML = 'Thank you for your message! Your email client will open to send the message directly.';
